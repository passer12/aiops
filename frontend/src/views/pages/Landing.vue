    ...
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
                <a class="flex align-items-center" href="#"> <img :src="logoUrl" alt="Sakai Logo" height="50" class="mr-0 lg:mr-2" /><span class="text-900 font-medium text-2xl line-height-3 mr-8">AIGIT</span> </a>
                ...
                <div class="align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2" style="top: 120px">
                    ...
                    <div class="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
                        <Button label="Login" class="p-button-text p-button-rounded border-none font-light line-height-2 text-blue-500" @click="redirectToLogin"></Button>
                        <Button label="Register" class="p-button-rounded border-none ml-5 font-light text-white line-height-2 bg-blue-500" @click="redirectToRegister"></Button>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="mx-4 md:mx-8 mt-0 md:mt-4">
                    <h1 class="text-6xl font-bold text-gray-900 line-height-2"><span class="font-light block">AIGIT</span>power your git with ai</h1>
            ...
            <div id="features" class="py-4 px-4 lg:px-8 mt-5 mx-0 lg:mx-8">
                <div class="grid justify-content-center">
                    <div class="col-12 text-center mt-8 mb-4">
                        ...
                        <span class="text-600 text-2xl">我们有以下特性</span>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">容易使用</h5>
                                <span class="text-600">界面简单流畅，易于使用</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">全新设计</h5>
                                <span class="text-600">vue3风格设计，简约大气</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">文档支持</h5>
                                <span class="text-600">文档详细，方便使用</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">响应式网页</h5>
                                <span class="text-600">组件响应式设计</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">高效代码处理</h5>
                                <span class="text-600">快速</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pb-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">暗黑主题</h5>
                                <span class="text-600">护眼</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">注册即用</h5>
                                <span class="text-600">方便快捷</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 md:col-12 lg:col-4 p-0 lg:pr-5 mt-4 lg:mt-0">
                        ...
                        >
                            <div class="p-3 surface-card h-full" style="border-radius: 8px">
                                ...
                                <h5 class="mb-2 text-900">现代实践</h5>
                                <span class="text-600">集成大语言模型</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--                            <h3 class="text-gray-900 mb-2">鲁迅</h3>-->
                    <!--                            <span class="text-gray-600 text-2xl"></span>-->
                    <!--                            <p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-4" style="max-width: 800px">“我先付款了“</p>-->
            ...
            <div id="highlights" class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8">
                <div class="text-center">
                    ...
                    <span class="text-600 text-2xl">多平台可用</span>
                </div>
                ...
                <div class="grid mt-8 pb-2 md:pb-8">
                    ...
                    <div class="col-12 lg:col-6 my-auto flex flex-column lg:align-items-end text-center lg:text-right">
                        ...
                        <h2 class="line-height-1 text-900 text-4xl font-normal">移动端</h2>
                ...
                <div class="grid my-8 pt-2 md:pt-8">
                    <div class="col-12 lg:col-6 my-auto flex flex-column text-center lg:text-left lg:align-items-start">
                        ...
                        <h2 class="line-height-1 text-900 text-4xl font-normal">PC端</h2>
            ...
            <div id="pricing" class="py-4 px-4 lg:px-8 my-2 md:my-4">
                <div class="text-center">
                    ...
                    <span class="text-600 text-2xl">不同套餐</span>
                </div>
                    ...
                    <div class="col-12 lg:col-4 p-0 md:p-3">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <div class="my-5 text-center">
                                ...
                                <Button label="Get Started" @click="redirectToRegister" class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light line-height-2 bg-blue-500 text-white"></Button>
                            </div>
                            <Divider class="w-full bg-surface-200"></Divider>
                            <ul class="my-5 list-none p-0 flex text-900 flex-column">
                                <li class="py-2">
                                    <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                    <span class="text-xl line-height-3">全部功能</span>
                                </li>
                                <!--                                <li class="py-2">-->
                                <!--                                    <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>-->
                    ...
                    <div class="col-12 lg:col-4 p-0 md:p-3 mt-4 md:mt-0">
                        <div class="p-3 flex flex-column border-200 pricing-card cursor-pointer border-2 hover:border-primary transition-duration-300 transition-all" style="border-radius: 10px">
                            ...
                            <ul class="my-5 list-none p-0 flex text-900 flex-column">
                                <li class="py-2">
                                    <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>
                                    <span class="text-xl line-height-3">敬请期待</span>
                                </li>
                                <!--                                <li class="py-2">-->
                                <!--                                    <i class="pi pi-fw pi-check text-xl text-cyan-500 mr-2"></i>-->
                                <!--                                    <span class="text-xl line-height-3">Unlimited Push Messages</span>-->
                ...
                <div class="grid justify-content-between">
                    <div class="col-12 md:col-2" style="margin-top: -1.5rem">
                        <a @click="smoothScroll('#home')" class="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3 cursor-pointer">
                            ...
                            <h4 class="font-medium text-3xl text-900">AIGIT</h4>
                        </a>
                    </div>
