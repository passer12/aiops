...
<template>
    ...
    <br>
    <Card style="width: 70%">
        <template #title>可维护性评分</template>
        <template #content>
<!--            <div class="text-900 font-medium text-xl">{{ rating }}</div>-->
    ...
    <Card style="width: 70%">
        ...
        <template #content>
            <div class="text-900 font-medium text-xl">{{file_score.maintainability.evaluations}}</div>
        </template>
    </Card>
    <br />
    <Card style="width: 70%">
        ...
        <template #content>
            <div class="text-900 font-medium text-xl">{{ file_score.maintainability.suggestions }}</div>
        </template>
    </Card>
</template>
