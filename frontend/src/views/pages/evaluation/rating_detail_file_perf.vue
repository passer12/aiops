...
const rating = ref(10*file_score.performance.score)
</script>
...
<!--            <div class="text-900 font-medium text-xl">{{ rating }}</div>-->
    ...
    <Card style="width: 70%">
        ...
        <template #content>
            <div class="text-900 font-medium text-xl">{{file_score.performance.evaluations}}</div>
        </template>
    </Card>
    <br />
    <Card style="width: 70%">
        ...
        <template #content>
            <div class="text-900 font-medium text-xl">{{file_score.performance.suggestions}}</div>
        </template>
    </Card>
</template>
