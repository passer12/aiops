...
<template>
    <h1>there is nothing i can show you</h1>
    <h1>developing ....</h1>
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">git仓库个数</span>
                        <div class="text-900 font-medium text-xl">{{ status.repo_num }}</div>
                    </div>
