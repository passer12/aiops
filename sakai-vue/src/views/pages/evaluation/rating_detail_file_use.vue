...
console.log('file_score', file_score.usability.score);

const rating = ref(10*file_score.usability.score)
</script>
...
<!--            <div class="text-900 font-medium text-xl">{{ rating }}</div>-->
    ...
    <Card style="width: 70%">
        ...
        <template #content>
            <div class="text-900 font-medium text-xl">{{file_score.usability.evaluations}}</div>
        </template>
    </Card>
    <br />
    <Card style="width: 70%">
        ...
        <template #content>
            <div class="text-900 font-medium text-xl">{{ file_score.usability.suggestions }}</div>
        </template>
    </Card>
</template>
