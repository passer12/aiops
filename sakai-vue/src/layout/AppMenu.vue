...
const model = ref([
    ...
    //     label: '功能',
    //     items: [
    // { label: '你的仓库', icon: 'pi pi-fw pi-id-card', to: '/uikit/result' },
    // { label: '个人配置', icon: 'pi pi-fw pi-bars', to: '/uikit/button', class: 'rotated-icon' },
    // { label: '历史记录', icon: 'pi pi-fw pi-calendar', to: '/uikit/input' },
    // { label: '剩余额度', icon: 'pi pi-fw pi-chart-bar', to: '/uikit/input' },
